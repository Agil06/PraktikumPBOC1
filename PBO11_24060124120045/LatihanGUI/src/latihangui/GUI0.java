...
public class GUI0 extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GUI0.class.getName());
    ...
    * @param args the command line arguments
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new GUI0().setVisible(true));
    }
